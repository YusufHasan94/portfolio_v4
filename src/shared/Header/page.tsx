      ...
      <div className='max-w-[1240px] mx-auto'>
        ...
        <div id="mobile-nav" className='lg:hidden flex flex-col justify-between'>
          <div className='flex items-center justify-between'>
            ...
            {handleActive ?
              <button onClick={() => handleToggle(false)}><AiOutlineCloseCircle style={{ fontSize: "30px" }} /></button>
              :
              <button onClick={() => handleToggle(true)}><GiHamburgerMenu style={{ fontSize: "30px" }} /></button>
            }
          </div>
          {handleActive &&
            (<motion.div
